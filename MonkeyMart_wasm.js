...
function _PokiSdkJs_RewardedBreak(callback, category, details, placement) {
    PokiSdk._callback = callback;
    PokiSDK.rewardedBreak(UTF8ToString(category), UTF8ToString(details), UTF8ToString(placement)).then(PokiSdk._rewardedBreakCallback)
}
...
var MEMFS = {
    ...
    node_ops: {
        ...
        readdir: function readdir(node) {
            var entries = [".", ".."];
            for (var _i2 = 0, _Object$keys = Object.keys(node.contents); _i2 < _Object$keys.length; _i2++) {
...
var listener = {
    onRemoteConfigsUpdated: function onRemoteConfigsUpdated() {
...
var wasmImports = {
    Hi: _PokiSdkJs_AddParameterForURL,
    Gi: _PokiSdkJs_CaptureError,
    Fi: _PokiSdkJs_CommercialBreak,
    Ei: _PokiSdkJs_GameplayStart,
    Di: _PokiSdkJs_GameplayStop,
    Ci: _PokiSdkJs_GetURLParam,
    Bi: _PokiSdkJs_InternalCaptureError,
    Ai: _PokiSdkJs_IsAdBlocked,
    zi: _PokiSdkJs_RewardedBreak,
    yi: _PokiSdkJs_SetDebug,
    xi: _PokiSdkJs_ShareableURL,
    b: ___assert_fail,
    wi: ___syscall__newselect,
    vi: ___syscall_accept4,
    ui: ___syscall_bind,
    ti: ___syscall_connect,
    si: ___syscall_dup3,
    g: ___syscall_fcntl64,
    ri: ___syscall_getpeername,
    qi: ___syscall_getsockname,
    aa: ___syscall_getsockopt,
    pi: ___syscall_ioctl,
    oi: ___syscall_listen,
    ni: ___syscall_mkdirat,
    $: ___syscall_openat,
    mi: ___syscall_poll,
    li: ___syscall_readlinkat,
    ki: ___syscall_recvfrom,
    ji: ___syscall_renameat,
    ii: ___syscall_rmdir,
    hi: ___syscall_sendto,
    za: ___syscall_socket,
    gi: ___syscall_stat64,
    _: ___syscall_unlinkat,
    di: __abort_js,
    ci: __emscripten_get_now_is_monotonic,
    bi: __emscripten_lookup_name,
    ai: __emscripten_memcpy_js,
    $h: __emscripten_system,
    _h: __emscripten_throw_longjmp,
    Ea: __gmtime_js,
    Da: __localtime_js,
    Ca: __mktime_js,
    Zh: __tzset_js,
    Yh: _dmDeviceJSFreeBufferSlots,
    Xh: _dmDeviceJSOpen,
    Wh: _dmDeviceJSQueue,
    Vh: _dmGetDeviceSampleRate,
    Uh: _dmResZipRequestFileAsync,
    Th: _dmScriptHttpRequestAsync,
    Sh: _dmSysGetApplicationPath,
    Rh: _dmSysGetUserAgent,
    Qh: _dmSysGetUserPersistentDataRoot,
    Ph: _dmSysGetUserPreferredLanguage,
    Oh: _dmSysOpenURL,
    E: _emscripten_asm_const_int,
    Nh: _emscripten_cancel_main_loop,
    D: _emscripten_date_now,
    Mh: _emscripten_get_heap_max,
    xa: _emscripten_get_now,
    Lh: _emscripten_glActiveTexture,
    Kh: _emscripten_glAttachShader,
    Jh: _emscripten_glBeginQuery,
    Ih: _emscripten_glBeginQueryEXT,
    Hh: _emscripten_glBeginTransformFeedback,
    Gh: _emscripten_glBindAttribLocation,
    Fh: _emscripten_glBindBuffer,
    Eh: _emscripten_glBindBufferBase,
    Dh: _emscripten_glBindBufferRange,
    Ch: _emscripten_glBindFramebuffer,
    Bh: _emscripten_glBindRenderbuffer,
    Ah: _emscripten_glBindSampler,
    zh: _emscripten_glBindTexture,
    yh: _emscripten_glBindTransformFeedback,
    xh: _emscripten_glBindVertexArray,
    wh: _emscripten_glBindVertexArrayOES,
    vh: _emscripten_glBlendColor,
    uh: _emscripten_glBlendEquation,
    th: _emscripten_glBlendEquationSeparate,
    sh: _emscripten_glBlendFunc,
    rh: _emscripten_glBlendFuncSeparate,
    qh: _emscripten_glBlitFramebuffer,
    ph: _emscripten_glBufferData,
    oh: _emscripten_glBufferSubData,
    nh: _emscripten_glCheckFramebufferStatus,
    mh: _emscripten_glClear,
    lh: _emscripten_glClearBufferfi,
    kh: _emscripten_glClearBufferfv,
    jh: _emscripten_glClearBufferiv,
    ih: _emscripten_glClearBufferuiv,
    hh: _emscripten_glClearColor,
    gh: _emscripten_glClearDepthf,
    fh: _emscripten_glClearStencil,
    eh: _emscripten_glClientWaitSync,
    dh: _emscripten_glColorMask,
    ch: _emscripten_glCompileShader,
    bh: _emscripten_glCompressedTexImage2D,
    ah: _emscripten_glCompressedTexImage3D,
    $g: _emscripten_glCompressedTexSubImage2D,
    _g: _emscripten_glCompressedTexSubImage3D,
    Zg: _emscripten_glCopyBufferSubData,
    Yg: _emscripten_glCopyTexImage2D,
    Xg: _emscripten_glCopyTexSubImage2D,
    Wg: _emscripten_glCopyTexSubImage3D,
    Vg: _emscripten_glCreateProgram,
    Ug: _emscripten_glCreateShader,
    Tg: _emscripten_glCullFace,
    Sg: _emscripten_glDeleteBuffers,
    Rg: _emscripten_glDeleteFramebuffers,
    Qg: _emscripten_glDeleteProgram,
    Pg: _emscripten_glDeleteQueries,
    Og: _emscripten_glDeleteQueriesEXT,
    Ng: _emscripten_glDeleteRenderbuffers,
    Mg: _emscripten_glDeleteSamplers,
    Lg: _emscripten_glDeleteShader,
    Kg: _emscripten_glDeleteSync,
    Jg: _emscripten_glDeleteTextures,
    Ig: _emscripten_glDeleteTransformFeedbacks,
    Hg: _emscripten_glDeleteVertexArrays,
    Gg: _emscripten_glDeleteVertexArraysOES,
    Fg: _emscripten_glDepthFunc,
    Eg: _emscripten_glDepthMask,
    Dg: _emscripten_glDepthRangef,
    Cg: _emscripten_glDetachShader,
    Bg: _emscripten_glDisable,
    Ag: _emscripten_glDisableVertexAttribArray,
    zg: _emscripten_glDrawArrays,
    yg: _emscripten_glDrawArraysInstanced,
    xg: _emscripten_glDrawArraysInstancedANGLE,
    wg: _emscripten_glDrawArraysInstancedARB,
    vg: _emscripten_glDrawArraysInstancedEXT,
    ug: _emscripten_glDrawArraysInstancedNV,
    tg: _emscripten_glDrawBuffers,
    sg: _emscripten_glDrawBuffersEXT,
    rg: _emscripten_glDrawBuffersWEBGL,
    qg: _emscripten_glDrawElements,
    pg: _emscripten_glDrawElementsInstanced,
    og: _emscripten_glDrawElementsInstancedANGLE,
    ng: _emscripten_glDrawElementsInstancedARB,
    mg: _emscripten_glDrawElementsInstancedEXT,
    lg: _emscripten_glDrawElementsInstancedNV,
    kg: _emscripten_glDrawRangeElements,
    jg: _emscripten_glEnable,
    ig: _emscripten_glEnableVertexAttribArray,
    hg: _emscripten_glEndQuery,
    gg: _emscripten_glEndQueryEXT,
    fg: _emscripten_glEndTransformFeedback,
    eg: _emscripten_glFenceSync,
    dg: _emscripten_glFinish,
    cg: _emscripten_glFlush,
    bg: _emscripten_glFramebufferRenderbuffer,
    ag: _emscripten_glFramebufferTexture2D,
    $f: _emscripten_glFramebufferTextureLayer,
    _f: _emscripten_glFrontFace,
    Zf: _emscripten_glGenBuffers,
    Yf: _emscripten_glGenFramebuffers,
    Xf: _emscripten_glGenQueries,
    Wf: _emscripten_glGenQueriesEXT,
    Vf: _emscripten_glGenRenderbuffers,
    Uf: _emscripten_glGenSamplers,
    Tf: _emscripten_glGenTextures,
    Sf: _emscripten_glGenTransformFeedbacks,
    Rf: _emscripten_glGenVertexArrays,
    Qf: _emscripten_glGenVertexArraysOES,
    Pf: _emscripten_glGenerateMipmap,
    Of: _emscripten_glGetActiveAttrib,
    Nf: _emscripten_glGetActiveUniform,
    Mf: _emscripten_glGetActiveUniformBlockName,
    Lf: _emscripten_glGetActiveUniformBlockiv,
    Kf: _emscripten_glGetActiveUniformsiv,
    Jf: _emscripten_glGetAttachedShaders,
    If: _emscripten_glGetAttribLocation,
    ...
    Cf: _emscripten_glGetFragDataLocation,
    Bf: _emscripten_glGetFramebufferAttachmentParameteriv,
    Af: _emscripten_glGetInteger64i_v,
    zf: _emscripten_glGetInteger64v,
    yf: _emscripten_glGetIntegeri_v,
    xf: _emscripten_glGetIntegerv,
    wf: _emscripten_glGetInternalformativ,
    vf: _emscripten_glGetProgramBinary,
    uf: _emscripten_glGetProgramInfoLog,
    tf: _emscripten_glGetProgramiv,
    sf: _emscripten_glGetQueryObjecti64vEXT,
    rf: _emscripten_glGetQueryObjectivEXT,
    qf: _emscripten_glGetQueryObjectui64vEXT,
    pf: _emscripten_glGetQueryObjectuiv,
    of: _emscripten_glGetQueryObjectuivEXT,
    nf: _emscripten_glGetQueryiv,
    mf: _emscripten_glGetQueryivEXT,
    lf: _emscripten_glGetRenderbufferParameteriv,
    kf: _emscripten_glGetSamplerParameterfv,
    jf: _emscripten_glGetSamplerParameteriv,
    hf: _emscripten_glGetShaderInfoLog,
    gf: _emscripten_glGetShaderPrecisionFormat,
    ff: _emscripten_glGetShaderSource,
    ef: _emscripten_glGetShaderiv,
    df: _emscripten_glGetString,
    cf: _emscripten_glGetStringi,
    bf: _emscripten_glGetSynciv,
    af: _emscripten_glGetTexParameterfv,
    $e: _emscripten_glGetTexParameteriv,
    _e: _emscripten_glGetTransformFeedbackVarying,
    Ze: _emscripten_glGetUniformBlockIndex,
    Ye: _emscripten_glGetUniformIndices,
    Xe: _emscripten_glGetUniformLocation,
    We: _emscripten_glGetUniformfv,
    Ve: _emscripten_glGetUniformiv,
    Ue: _emscripten_glGetUniformuiv,
    Te: _emscripten_glGetVertexAttribIiv,
    Se: _emscripten_glGetVertexAttribIuiv,
    Re: _emscripten_glGetVertexAttribPointerv,
    Qe: _emscripten_glGetVertexAttribfv,
    Pe: _emscripten_glGetVertexAttribiv,
    Oe: _emscripten_glHint,
    Ne: _emscripten_glInvalidateFramebuffer,
    Me: _emscripten_glInvalidateSubFramebuffer,
    Le: _emscripten_glIsBuffer,
    Ke: _emscripten_glIsEnabled,
    Je: _emscripten_glIsFramebuffer,
    Ie: _emscripten_glIsProgram,
    He: _emscripten_glIsQuery,
    Ge: _emscripten_glIsQueryEXT,
    Fe: _emscripten_glIsRenderbuffer,
    Ee: _emscripten_glIsSampler,
    De: _emscripten_glIsShader,
    Ce: _emscripten_glIsSync,
    Be: _emscripten_glIsTexture,
    Ae: _emscripten_glIsTransformFeedback,
    ze: _emscripten_glIsVertexArray,
    ye: _emscripten_glIsVertexArrayOES,
    xe: _emscripten_glLineWidth,
    we: _emscripten_glLinkProgram,
    ve: _emscripten_glPauseTransformFeedback,
    ue: _emscripten_glPixelStorei,
    te: _emscripten_glPolygonOffset,
    se: _emscripten_glProgramBinary,
    re: _emscripten_glProgramParameteri,
    qe: _emscripten_glQueryCounterEXT,
    pe: _emscripten_glReadBuffer,
    oe: _emscripten_glReadPixels,
    ne: _emscripten_glReleaseShaderCompiler,
    me: _emscripten_glRenderbufferStorage,
    le: _emscripten_glRenderbufferStorageMultisample,
    ke: _emscripten_glResumeTransformFeedback,
    je: _emscripten_glSampleCoverage,
    ie: _emscripten_glSamplerParameterf,
    he: _emscripten_glSamplerParameterfv,
    ge: _emscripten_glSamplerParameteri,
    fe: _emscripten_glSamplerParameteriv,
    ...
    Wd: _emscripten_glTexImage3D,
    Vd: _emscripten_glTexParameterf,
    Ud: _emscripten_glTexParameterfv,
    Td: _emscripten_glTexParameteri,
    Sd: _emscripten_glTexParameteriv,
    Rd: _emscripten_glTexStorage2D,
    Qd: _emscripten_glTexStorage3D,
    Pd: _emscripten_glTexSubImage2D,
    Od: _emscripten_glTexSubImage3D,
    Nd: _emscripten_glTransformFeedbackVaryings,
    Md: _emscripten_glUniform1f,
    Ld: _emscripten_glUniform1fv,
    Kd: _emscripten_glUniform1i,
    Jd: _emscripten_glUniform1iv,
    Id: _emscripten_glUniform1ui,
    Hd: _emscripten_glUniform1uiv,
    Gd: _emscripten_glUniform2f,
    Fd: _emscripten_glUniform2fv,
    Ed: _emscripten_glUniform2i,
    Dd: _emscripten_glUniform2iv,
    Cd: _emscripten_glUniform2ui,
    Bd: _emscripten_glUniform2uiv,
    Ad: _emscripten_glUniform3f,
    zd: _emscripten_glUniform3fv,
    yd: _emscripten_glUniform3i,
    xd: _emscripten_glUniform3iv,
    wd: _emscripten_glUniform3ui,
    vd: _emscripten_glUniform3uiv,
    ud: _emscripten_glUniform4f,
    td: _emscripten_glUniform4fv,
    sd: _emscripten_glUniform4i,
    rd: _emscripten_glUniform4iv,
    qd: _emscripten_glUniform4ui,
    pd: _emscripten_glUniform4uiv,
    od: _emscripten_glUniformBlockBinding,
    nd: _emscripten_glUniformMatrix2fv,
    md: _emscripten_glUniformMatrix2x3fv,
    ld: _emscripten_glUniformMatrix2x4fv,
    kd: _emscripten_glUniformMatrix3fv,
    jd: _emscripten_glUniformMatrix3x2fv,
    id: _emscripten_glUniformMatrix3x4fv,
    hd: _emscripten_glUniformMatrix4fv,
    gd: _emscripten_glUniformMatrix4x2fv,
    fd: _emscripten_glUniformMatrix4x3fv,
    ed: _emscripten_glUseProgram,
    dd: _emscripten_glValidateProgram,
    cd: _emscripten_glVertexAttrib1f,
    bd: _emscripten_glVertexAttrib1fv,
    ad: _emscripten_glVertexAttrib2f,
    $c: _emscripten_glVertexAttrib2fv,
    _c: _emscripten_glVertexAttrib3f,
    Zc: _emscripten_glVertexAttrib3fv,
    Yc: _emscripten_glVertexAttrib4f,
    Xc: _emscripten_glVertexAttrib4fv,
    Wc: _emscripten_glVertexAttribDivisor,
    Vc: _emscripten_glVertexAttribDivisorANGLE,
    Uc: _emscripten_glVertexAttribDivisorARB,
    Tc: _emscripten_glVertexAttribDivisorEXT,
    Sc: _emscripten_glVertexAttribDivisorNV,
    Rc: _emscripten_glVertexAttribI4i,
    Qc: _emscripten_glVertexAttribI4iv,
    Pc: _emscripten_glVertexAttribI4ui,
    Oc: _emscripten_glVertexAttribI4uiv,
    Nc: _emscripten_glVertexAttribIPointer,
    Mc: _emscripten_glVertexAttribPointer,
    Lc: _emscripten_glViewport,
    Kc: _emscripten_glWaitSync,
    Jc: _emscripten_pause_main_loop,
    Ic: _emscripten_resize_heap,
    Y: _emscripten_set_main_loop_arg,
    d: _emscripten_webgl_enable_extension,
    Hc: _emscripten_webgl_get_current_context,
    fi: _environ_get,
    ei: _environ_sizes_get,
    X: _exit,
    F: _fd_close,
    ya: _fd_read,
    Fa: _fd_seek,
    ...
    W: _glAttachShader,
    e: _glBindBuffer,
    va: _glBindBufferBase,
    V: _glBindFramebuffer,
    s: _glBindRenderbuffer,
    n: _glBindTexture,
    Gc: _glBindVertexArray,
    Fc: _glBlendFunc,
    P: _glBufferData,
    ua: _glBufferSubData,
    ...
    ta: _glCompressedTexImage3D,
    l: _glCompressedTexSubImage2D,
    zc: _glCompressedTexSubImage3D,
    sa: _glCreateProgram,
    N: _glCreateShader,
    yc: _glCullFace,
    ra: _glDeleteBuffers,
    xc: _glDeleteFramebuffers,
    U: _glDeleteProgram,
    ...
    vc: _glDepthMask,
    uc: _glDisable,
    tc: _glDisableVertexAttribArray,
    sc: _glDrawArrays,
    rc: _glDrawArraysInstanced,
    qc: _glDrawBuffers,
    pc: _glDrawElements,
    oc: _glDrawElementsInstanced,
    nc: _glEnable,
    mc: _glEnableVertexAttribArray,
    lc: _glFlush,
    kc: _glFramebufferRenderbuffer,
    jc: _glFramebufferTexture2D,
    ic: _glFrontFace,
    T: _glGenBuffers,
    hc: _glGenFramebuffers,
    A: _glGenRenderbuffers,
    pa: _glGenTextures,
    gc: _glGenVertexArrays,
    fc: _glGetActiveAttrib,
    ec: _glGetActiveUniform,
    M: _glGetActiveUniformBlockiv,
    oa: _glGetActiveUniformsiv,
    ...
    L: _glGetShaderiv,
    y: _glGetString,
    bc: _glGetUniformBlockIndex,
    ac: _glGetUniformLocation,
    K: _glLinkProgram,
    la: _glPixelStorei,
    $b: _glPolygonOffset,
    _b: _glReadPixels,
    ...
    x: _glShaderSource,
    Yb: _glStencilFunc,
    Xb: _glStencilFuncSeparate,
    Wb: _glStencilMask,
    Vb: _glStencilOp,
    Ub: _glStencilOpSeparate,
    i: _glTexImage2D,
    Tb: _glTexImage3D,
    Sb: _glTexParameterf,
    J: _glTexParameteri,
    ...
    ka: _glUseProgram,
    Mb: _glVertexAttribDivisor,
    Lb: _glVertexAttribPointer,
    Kb: _glViewport,
    Jb: _glfwAccelerometerEnable,
    Ib: _glfwCloseWindow,
    Hb: _glfwDisable,
    Gb: _glfwEnable,
    Fb: _glfwGetAcceleration,
    ja: _glfwGetDefaultFramebuffer,
    Eb: _glfwGetDisplayScaleFactor,
    Db: _glfwGetJoystickButtons,
    Cb: _glfwGetJoystickDeviceId,
    Bb: _glfwGetJoystickHats,
    I: _glfwGetJoystickParam,
    Ab: _glfwGetJoystickPos,
    zb: _glfwGetKey,
    h: _glfwGetMouseButton,
    yb: _glfwGetMouseLocked,
    xb: _glfwGetMousePos,
    wb: _glfwGetMouseWheel,
    vb: _glfwGetWindowParam,
    ub: _glfwGetWindowRefreshRate,
    ia: _glfwGetWindowSize,
    tb: _glfwIconifyWindow,
    sb: _glfwInitJS,
    ha: _glfwOpenWindow,
    w: _glfwOpenWindowHint,
    rb: _glfwPollEvents,
    qb: _glfwResetKeyboard,
    pb: _glfwSetCharCallback,
    ob: _glfwSetDeviceChangedCallback,
    nb: _glfwSetGamepadCallback,
    mb: _glfwSetMarkedTextCallback,
    lb: _glfwSetTouchCallback,
    kb: _glfwSetWindowBackgroundColor,
    jb: _glfwSetWindowCloseCallback,
    ib: _glfwSetWindowFocusCallback,
    hb: _glfwSetWindowIconifyCallback,
    gb: _glfwSetWindowSize,
    fb: _glfwSetWindowSizeCallback,
    H: _glfwShowKeyboard,
    eb: _glfwSwapBuffers,
    ...
    f: invoke_viiii,
    p: invoke_viiiii,
    cb: _js_addBusinessEvent,
    bb: _js_addDesignEvent,
    ab: _js_addDesignEventWithValue,
    $a: _js_addErrorEvent,
    _a: _js_addProgressionEvent,
    Za: _js_addProgressionEventWithScore,
    Ya: _js_addResourceEvent,
    Xa: _js_configureAvailableCustomDimensions01,
    Wa: _js_configureAvailableCustomDimensions02,
    Va: _js_configureAvailableCustomDimensions03,
    Ua: _js_configureAvailableResourceCurrencies,
    Ta: _js_configureAvailableResourceItemTypes,
    Sa: _js_configureBuild,
    Ra: _js_configureGameEngineVersion,
    Qa: _js_configureSdkGameEngineVersion,
    Pa: _js_configureUserId,
    Oa: _js_endSession,
    Na: _js_getRemoteConfigsContentAsString,
    Ma: _js_getRemoteConfigsValueAsStringWithDefaultValue,
    Q: _js_initialize,
    La: _js_isRemoteConfigsReady,
    Ka: _js_setCustomDimension01,
    Ja: _js_setCustomDimension02,
    Ia: _js_setCustomDimension03,
    ea: _js_setEnabledInfoLog,
    da: _js_setEnabledVerboseLog,
    ca: _js_setEventSubmission,
    Ha: _js_setGlobalCustomEventFields,
    ba: _js_setManualSessionHandling,
    Ga: _js_startSession,
    a: wasmMemory
};
...
var _js_remote_configs_callback = Module["_js_remote_configs_callback"] = function() {
    return (_js_remote_configs_callback = Module["_js_remote_configs_callback"] = wasmExports["Oi"])()
};
var _htonl2 = function _htonl(a0) {
    return (_htonl2 = wasmExports["Pi"])(a0)
};
var _dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = function(a0) {
    return (_dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = wasmExports["Qi"])(a0)
};
var _dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = function() {
    return (_dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = wasmExports["Ri"])()
};
...
var _emscripten_tempret_set = function __emscripten_tempret_set(a0) {
    return (_emscripten_tempret_set = wasmExports["Wi"])(a0)
};
var _emscripten_stack_restore = function __emscripten_stack_restore(a0) {
    return (_emscripten_stack_restore = wasmExports["Xi"])(a0)
};
var _emscripten_stack_alloc = function __emscripten_stack_alloc(a0) {
    return (_emscripten_stack_alloc = wasmExports["Yi"])(a0)
};
var _emscripten_stack_get_current2 = function _emscripten_stack_get_current() {
    return (_emscripten_stack_get_current2 = wasmExports["Zi"])()
};
var dynCall_jii = Module["dynCall_jii"] = function(a0, a1, a2) {
    return (dynCall_jii = Module["dynCall_jii"] = wasmExports["_i"])(a0, a1, a2)
};
var dynCall_ji = Module["dynCall_ji"] = function(a0, a1) {
    return (dynCall_ji = Module["dynCall_ji"] = wasmExports["$i"])(a0, a1)
};
